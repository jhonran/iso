...
--
-- Host: 127.0.0.1
-- Generation Time: 03 Mei 2018 pada 09.55
...
--
-- Struktur dari tabel `t_log_data`
--
...
--
-- Dumping data untuk tabel `t_log_data`
--

INSERT INTO `t_log_data` (`id_log_data`, `log_date`, `log_user`, `log_desc`) VALUES
(1, '2018-05-03', 'admin', 'logout'),
(2, '2018-05-03', 'admin', 'Login'),
(3, '2018-05-03', 'admin', 'logout');
...
CREATE TABLE `t_menu` (
  ...
  `level_menu` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `t_menu` (`id_menu`, `nama_menu`, `link_menu`, `level_menu`) VALUES
(1, 'Database', 'database', '1'),
(2, 'Data User', 'operator', '1');
...
--
-- Indexes for table `t_log_data`
--
ALTER TABLE `t_log_data`
...
--
-- AUTO_INCREMENT for table `t_log_data`
--
ALTER TABLE `t_log_data`
  MODIFY `id_log_data` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
